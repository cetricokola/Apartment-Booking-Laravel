...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    formSubmit: function formSubmit(e) {
      ...
      _http_common__WEBPACK_IMPORTED_MODULE_1__["HTTP"].post("add_image/".concat(this.id), formData, config).then(function (response) {
